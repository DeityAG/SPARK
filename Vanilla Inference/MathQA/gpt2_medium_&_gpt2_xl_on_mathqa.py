# -*- coding: utf-8 -*-
"""Gpt2-medium_&_Gpt2-xl_on_MathQA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1pbkgOFlc4UQ9FbGbYq_iQzqKQRho7EaR
"""
...
def extract_option_answer(text):
    """Extract the letter option (a–e) from model output."""
...
# ============================================================
# 🧩 STEP 4: Batched inference for GPT-2 (T4 friendly)
# ============================================================
...
# ============================================================
gpt2_models = [
    ("openai-community/gpt2-medium", 4),  # 0.4B params
    ("openai-community/gpt2-xl", 1)       # 2B params
]

gpt2_results = {}
for model_name, batch_size in gpt2_models:
    gpt2_results[model_name] = run_inference_batched(model_name, test_data, batch_size=batch_size)

# ============================================================
# 🧩 STEP 6: Display Results
# ============================================================
df_gpt2 = pd.DataFrame(gpt2_results).T
print("\n📊 Baseline Vanilla Inference Results (full MathQA dataset) for GPT-2 models:")
display(df_gpt2)
