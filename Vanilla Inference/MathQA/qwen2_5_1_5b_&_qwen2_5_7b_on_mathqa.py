# -*- coding: utf-8 -*-
"""Qwen2.5-1.5B_&_Qwen2.5-7B_on_MathQA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mhX8UlGotS82phec8QXV3kShfSLzpVE4
"""
...
def extract_option_answer(text):
    """Extracts the final letter option (a-e) from the model output."""
...
print("\n📊 Baseline Vanilla Inference Results (full MathQA dataset) for Qwen2.5 models:")
display(df_qwen)
